...
class MenuQueries(graphene.ObjectType):
    ...
    @staticmethod
    def resolve_menu(_root, info: graphene.ResolveInfo, *, channel=None, **data):
        if channel is None:
    ...
    @staticmethod
    def resolve_menus(_root, info: graphene.ResolveInfo, *, channel=None, **kwargs):
        if channel is None:
            channel = get_default_channel_slug_or_graphql_error()
    ...
    @staticmethod
    def resolve_menu_item(_root, _info: graphene.ResolveInfo, *, channel=None, **data):
        if channel is None:
            channel = get_default_channel_slug_or_graphql_error()
