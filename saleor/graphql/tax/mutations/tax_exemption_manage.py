...
class TaxExemptionManage(BaseMutation):
    ...
    @classmethod
    def validate_input(cls, info: graphene.ResolveInfo, data):
    ...
    @classmethod
    def get_object(cls, info: graphene.ResolveInfo, object_global_id):
        obj = graphene.Node.get_node_from_global_id(info, object_global_id)
        return obj

    @classmethod
    def _invalidate_checkout_prices(cls, info: graphene.ResolveInfo, checkout):
