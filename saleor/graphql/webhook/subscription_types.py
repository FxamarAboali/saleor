...
class Event(graphene.Interface):
    ...
    @staticmethod
    def resolve_issued_at(_root, _info: graphene.ResolveInfo):
        return timezone.now()

    @staticmethod
    def resolve_version(_root, _info: graphene.ResolveInfo):
        return __version__

    @staticmethod
    def resolve_recipient(_root, info: graphene.ResolveInfo):
        return info.context.app

    @staticmethod
    def resolve_issuing_principal(_root, info: graphene.ResolveInfo):
...
class AddressBase(AbstractType):
    ...
    @staticmethod
    def resolve_address(root, _info: graphene.ResolveInfo):
        _, address = root
        return address
...
class AppBase(AbstractType):
    ...
    @staticmethod
    def resolve_app(root, _info: graphene.ResolveInfo):
        _, app = root
        return app
...
class AttributeBase(AbstractType):
    ...
    @staticmethod
    def resolve_attribute(root, _info: graphene.ResolveInfo):
        _, attribute = root
        return attribute
...
class AttributeValueBase(AbstractType):
    ...
    @staticmethod
    def resolve_attribute_value(root, _info: graphene.ResolveInfo):
        _, attribute = root
        return attribute
...
class CategoryBase(AbstractType):
    ...
    @staticmethod
    def resolve_category(root, info: graphene.ResolveInfo):
        _, category = root
        return category
...
class ChannelBase(AbstractType):
    ...
    @staticmethod
    def resolve_channel(root, info: graphene.ResolveInfo):
        _, channel = root
        return channel
...
class OrderBase(AbstractType):
    ...
    @staticmethod
    def resolve_order(root, info: graphene.ResolveInfo):
        _, order = root
        return order
...
class GiftCardBase(AbstractType):
    ...
    @staticmethod
    def resolve_gift_card(root, info: graphene.ResolveInfo):
        _, gift_card = root
        return gift_card
...
class MenuBase(AbstractType):
    ...
    @staticmethod
    def resolve_menu(root, info: graphene.ResolveInfo, channel=None):
        _, menu = root
...
class MenuItemBase(AbstractType):
    ...
    @staticmethod
    def resolve_menu_item(root, info: graphene.ResolveInfo, channel=None):
        _, menu_item = root
...
class ProductBase(AbstractType):
    ...
    @staticmethod
    def resolve_product(root, info: graphene.ResolveInfo, channel=None):
        _, product = root
        return ChannelContext(node=product, channel_slug=channel)

    @staticmethod
    def resolve_category(root, _info: graphene.ResolveInfo):
        _, product = root
...
class ProductVariantBase(AbstractType):
    ...
    @staticmethod
    def resolve_product_variant(root, _info: graphene.ResolveInfo, channel=None):
        _, variant = root
...
class ProductVariantOutOfStock(ObjectType, ProductVariantBase):
    ...
    @staticmethod
    def resolve_product_variant(root, info: graphene.ResolveInfo, channel=None):
        _, stock = root
...
class SaleBase(AbstractType):
    ...
    @staticmethod
    def resolve_sale(root, info: graphene.ResolveInfo, channel=None):
        _, sale = root
...
class InvoiceBase(AbstractType):
    ...
    @staticmethod
    def resolve_invoice(root, _info: graphene.ResolveInfo):
        _, invoice = root
        return invoice

    @staticmethod
    def resolve_order(root, _info: graphene.ResolveInfo):
        _, invoice = root
...
class FulfillmentBase(AbstractType):
    ...
    @staticmethod
    def resolve_fulfillment(root, _info: graphene.ResolveInfo):
        _, fulfillment = root
        return fulfillment
...
class UserBase(AbstractType):
    ...
    @staticmethod
    def resolve_user(root, _info: graphene.ResolveInfo):
        _, user = root
        return user
...
class CollectionBase(AbstractType):
    ...
    @staticmethod
    def resolve_collection(root, _info: graphene.ResolveInfo, channel=None):
        _, collection = root
...
class CheckoutBase(AbstractType):
    ...
    @staticmethod
    def resolve_checkout(root, _info: graphene.ResolveInfo):
        _, checkout = root
        return checkout
...
class PageBase(AbstractType):
    ...
    @staticmethod
    def resolve_page(root, _info: graphene.ResolveInfo):
        _, page = root
        return page
...
class PageTypeBase(AbstractType):
    ...
    @staticmethod
    def resolve_page_type(root, _info: graphene.ResolveInfo):
        _, page_type = root
        return page_type
...
class PermissionGroupBase(AbstractType):
    ...
    @staticmethod
    def resolve_permission_group(root, _info: graphene.ResolveInfo):
...
class ShippingPriceBase(AbstractType):
    ...
    @staticmethod
    def resolve_shipping_method(root, _info: graphene.ResolveInfo, channel=None):
        _, shipping_method = root
        return ChannelContext(node=shipping_method, channel_slug=channel)

    @staticmethod
    def resolve_shipping_zone(root, _info: graphene.ResolveInfo, channel=None):
        _, shipping_method = root
...
class TransactionAction(ObjectType, AbstractType):
    ...
    @staticmethod
    def resolve_amount(root: TransactionActionData, _info: graphene.ResolveInfo):
...
class TranslationBase(AbstractType):
    ...
    @staticmethod
    def resolve_translation(root, _info: graphene.ResolveInfo):
        _, translation = root
        return translation
...
class VoucherBase(AbstractType):
    ...
    @staticmethod
    def resolve_voucher(root, _info: graphene.ResolveInfo):
        _, voucher = root
...
class PaymentBase(AbstractType):
    ...
    @staticmethod
    def resolve_payment(root, _info: graphene.ResolveInfo):
        _, payment = root
        return payment
...
class ShippingListMethodsForCheckout(ObjectType, CheckoutBase):
    ...
    def resolve_shipping_methods(root, info: graphene.ResolveInfo, manager):
        _, checkout = root
...
class CalculateTaxes(ObjectType):
    ...
    def resolve_tax_base(root, info: graphene.ResolveInfo):
        _, tax_base = root
        return tax_base
...
class OrderFilterShippingMethods(ObjectType, OrderBase):
    ...
    @staticmethod
    def resolve_shipping_methods(root, info: graphene.ResolveInfo):
        _, order = root
...
class Subscription(ObjectType):
    ...
    @staticmethod
    def resolve_event(root, info: graphene.ResolveInfo):
