...
class Address(ModelObjectType):
    ...
    @staticmethod
    def resolve_country(root: models.Address, _info: graphene.ResolveInfo):
        return CountryDisplay(code=root.country.code, country=root.country.name)

    @staticmethod
    def resolve_is_default_shipping_address(
        root: models.Address, _info: graphene.ResolveInfo
    ):
    ...
    @staticmethod
    def resolve_is_default_billing_address(
        root: models.Address, _info: graphene.ResolveInfo
    ):
    ...
    @staticmethod
    def __resolve_references(roots: List["Address"], info: graphene.ResolveInfo):
...
class CustomerEvent(ModelObjectType):
    ...
    @staticmethod
    def resolve_user(root: models.CustomerEvent, info: graphene.ResolveInfo):
    ...
    @staticmethod
    def resolve_app(root: models.CustomerEvent, info: graphene.ResolveInfo):
    ...
    @staticmethod
    def resolve_message(root: models.CustomerEvent, _info: graphene.ResolveInfo):
        return root.parameters.get("message", None)

    @staticmethod
    def resolve_count(root: models.CustomerEvent, _info: graphene.ResolveInfo):
        return root.parameters.get("count", None)

    @staticmethod
    def resolve_order_line(root: models.CustomerEvent, info: graphene.ResolveInfo):
...
class UserPermission(Permission):
    ...
    @staticmethod
    @traced_resolver
    def resolve_source_permission_groups(
        root: Permission, _info: graphene.ResolveInfo, user_id
    ):
...
class User(ModelObjectType):
    ...
    @staticmethod
    def resolve_addresses(root: models.User, _info: graphene.ResolveInfo):
        return root.addresses.annotate_default(root).all()  # type: ignore

    @staticmethod
    def resolve_checkout(root: models.User, _info: graphene.ResolveInfo):
        return get_user_checkout(root)

    @staticmethod
    @traced_resolver
    def resolve_checkout_tokens(
        root: models.User, info: graphene.ResolveInfo, channel=None
    ):
    ...
    @staticmethod
    def resolve_checkouts(root: models.User, info: graphene.ResolveInfo, **kwargs):
    ...
    @staticmethod
    def resolve_gift_cards(root: models.User, info: graphene.ResolveInfo, **kwargs):
    ...
    @staticmethod
    def resolve_user_permissions(root: models.User, _info: graphene.ResolveInfo):
        from .resolvers import resolve_permissions

        return resolve_permissions(root)

    @staticmethod
    def resolve_permission_groups(root: models.User, _info: graphene.ResolveInfo):
        return root.groups.all()

    @staticmethod
    def resolve_editable_groups(root: models.User, _info: graphene.ResolveInfo):
        return get_groups_which_user_can_manage(root)

    @staticmethod
    def resolve_note(root: models.User, info: graphene.ResolveInfo):
        return root.note

    @staticmethod
    def resolve_events(root: models.User, info: graphene.ResolveInfo):
        return CustomerEventsByUserLoader(info.context).load(root.id)

    @staticmethod
    def resolve_orders(root: models.User, info: graphene.ResolveInfo, **kwargs):
    ...
    @staticmethod
    def resolve_avatar(
        root: models.User, info: graphene.ResolveInfo, size=None, format=None
    ):
        if not root.avatar:
            return
    ...
    @staticmethod
    def __resolve_references(roots: List["User"], info: graphene.ResolveInfo):
...
class StaffNotificationRecipient(graphene.ObjectType):
    ...
    @staticmethod
    def resolve_user(
        root: models.StaffNotificationRecipient, info: graphene.ResolveInfo
    ):
        user = info.context.user
    ...
    @staticmethod
    def resolve_email(
        root: models.StaffNotificationRecipient, _info: graphene.ResolveInfo
    ):
...
class Group(ModelObjectType):
    ...
    @staticmethod
    def resolve_users(root: auth_models.Group, _info: graphene.ResolveInfo):
        return root.user_set.all()

    @staticmethod
    def resolve_permissions(root: auth_models.Group, _info: graphene.ResolveInfo):
    ...
    @staticmethod
    def resolve_user_can_manage(root: auth_models.Group, info: graphene.ResolveInfo):
        user = info.context.user
        return can_user_manage_group(user, root)

    @staticmethod
    def __resolve_references(roots: List["Group"], info: graphene.ResolveInfo):
